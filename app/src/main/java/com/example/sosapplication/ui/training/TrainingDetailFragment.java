...
public class TrainingDetailFragment extends Fragment {
    ...
    private void setupTraining() {
        List<TrainingStep> steps = getStepsForTraining(trainingId);
    ...
    private List<TrainingStep> getStepsForTraining(int id) {
        List<TrainingStep> steps = new ArrayList<>();
        
        switch (id) {
            case 1: // CPR - No Breathing
            ...
            case 2: // Choking
                steps.add(new TrainingStep(
                        ...
                        getString(R.string.choking_step_1_title),
                        getString(R.string.choking_step_1_desc)
                ));
                steps.add(new TrainingStep(
                        R.drawable.ic_launcher_foreground,
                        getString(R.string.choking_step_2_title),
                        getString(R.string.choking_step_2_desc)
                ));
                steps.add(new TrainingStep(
                        R.drawable.ic_launcher_foreground,
                        getString(R.string.choking_step_3_title),
                        getString(R.string.choking_step_3_desc)
                ));
                break;
            ...
            case 3: // Bleeding
                steps.add(new TrainingStep(
                        R.drawable.ic_launcher_foreground,
                        getString(R.string.bleeding_step_1_title),
                        getString(R.string.bleeding_step_1_desc)
                ));
                steps.add(new TrainingStep(
                        R.drawable.ic_launcher_foreground,
                        getString(R.string.bleeding_step_2_title),
                        getString(R.string.bleeding_step_2_desc)
                ));
                steps.add(new TrainingStep(
                        R.drawable.ic_launcher_foreground,
                        getString(R.string.bleeding_step_3_title),
                        getString(R.string.bleeding_step_3_desc)
                ));
                break;
            ...
            case 4: // Burns
                steps.add(new TrainingStep(
                        R.drawable.ic_launcher_foreground,
                        getString(R.string.burns_step_1_title),
                        getString(R.string.burns_step_1_desc)
                ));
                steps.add(new TrainingStep(
                        R.drawable.ic_launcher_foreground,
                        getString(R.string.burns_step_2_title),
                        getString(R.string.burns_step_2_desc)
                ));
                steps.add(new TrainingStep(
                        R.drawable.ic_launcher_foreground,
                        getString(R.string.burns_step_3_title),
                        getString(R.string.burns_step_3_desc)
                ));
                break;
            ...
            case 5: // Fractures
                steps.add(new TrainingStep(
                        R.drawable.ic_launcher_foreground,
                        getString(R.string.fracture_step_1_title),
                        getString(R.string.fracture_step_1_desc)
                ));
                steps.add(new TrainingStep(
                        R.drawable.ic_launcher_foreground,
                        getString(R.string.fracture_step_2_title),
                        getString(R.string.fracture_step_2_desc)
                ));
                steps.add(new TrainingStep(
                        R.drawable.ic_launcher_foreground,
                        getString(R.string.fracture_step_3_title),
                        getString(R.string.fracture_step_3_desc)
                ));
                break;
        }
